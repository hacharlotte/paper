...
def parse_args():
    ...
    parser.add_argument('--Trans_head', default=6, type=int, help='The relation confidence threshold ω')
    parser.add_argument('--Trans_layers', default=6, type=int, help='The relation confidence threshold ω')
    parser.add_argument('--GCN_layers', default=3, type=int, help='The relation confidence threshold ω')
    parser.add_argument('--GCN_heads', default=6, type=int, help='The relation confidence threshold ω')
    parser.add_argument('--iscat', default=1, type=int, help='The relation confidence threshold ω')
    parser.add_argument('--isatt', default=1, type=int, help='The relation confidence threshold ω')
    # # loss arguments
    parser.add_argument('--gamma', default=2.0, type=float, help='loss gamma argument')
    parser.add_argument('--no_of_classes', default=2, type=int, help='loss classes argument')
    parser.add_argument('--loss_type', default="focal", type=str, help='loss type')
    parser.add_argument('--max_iteration', default=8, type=int, help='Maximum iteration number L')
    ...
    parser.add_argument('--penal', default=1.0, type=float, help='The number of attention head K')

    # # training arguments
    parser.add_argument('--seed', default=209, type=int, help='seed for reproducibility')
    parser.add_argument("--batch_size", default=1, type=int)
    parser.add_argument('--epoch', default=50, type=int, help='number of total epochs to run')
