...
def parse_args():
    ...
    # dataset
    parser.add_argument("--dataset_type", default='CT', type=str, help='dataset name')
    ...
    parser.add_argument('--Trans_layers', default=8, type=int, help='The relation confidence threshold ω')
