...
import sys
sys.path.append('/home/kai/ha/iLIF')  # 将 iLIF 目录添加到 Python 路径
...
#         train_loader = DataLoader(train_dataset, batch_size=args.batch_size, sampler=SequentialSampler(train_dataset),
#                                   collate_fn=train_test_dataset.collate_fn)
        ...
        optimizer_grouped_parameters = [
            ...
            # {'params': [p for n, p in model.mlp_str.named_parameters() if not any(nd in n for nd in no_decay)],
            #  'weight_decay': args.weight_decay},
            # {'params': [p for n, p in model.mlp_str.named_parameters() if any(nd in n for nd in no_decay)],
            #  'weight_decay': 0.0},
        ...
        for epoch in range(1, args.epoch + 1):
            ...
            with torch.no_grad():
                ...
                if epoch % args.valid_epoch == 0:
                    ...
                    if valid_intra['f1'] >= best_valid_f1:
                        ...
                        best_model_path = os.path.join(args.output_dir, f"best_model_fold_{fold + 1}_{date_str}_F1_{valid_f1:.4f}.pt")
